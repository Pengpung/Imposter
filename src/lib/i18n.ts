export const translations = {
  en: {
    ...
    localModeDesc: 'Pass & play on one device',
    onlineModeDesc: 'Create or join a room',
    ...
    hostDevice: 'This device is the host',
    ...
    serverUrl: 'PeerJS Server',
    serverUrlPlaceholder: 'e.g. your-pc.local or 192.168.1.100',
    serverPort: 'Port',
    useDefaultServer: 'Use default (cloud)',
  ...
  zh: {
    ...
    localMode: '单机模式',
    onlineMode: '联机模式',
    localModeDesc: '一台设备传屏游玩',
    onlineModeDesc: '创建或加入房间',
    createRoom: '创建房间',
    joinRoom: '加入房间',
    roomCode: '房间号',
    enterRoomCode: '输入房间号',
    waitingForPlayers: '等待玩家加入...',
    connectedPlayers: '已连接',
    hostDevice: '本设备为房主',
    startOnlineGame: '开始游戏',
    leaveRoom: '离开房间',
    connecting: '连接中...',
    connected: '已连接！',
    ...
    serverUrl: 'PeerJS 服务器',
    serverUrlPlaceholder: '例如 你的电脑.local 或 192.168.1.100',
    serverPort: '端口',
    useDefaultServer: '使用默认（云端）',
